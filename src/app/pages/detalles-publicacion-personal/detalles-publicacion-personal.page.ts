...
@Component({
  selector: 'app-detalles-publicacion-personal',
  templateUrl: './detalles-publicacion-personal.page.html',
  styleUrls: ['./detalles-publicacion-personal.page.scss'],
    standalone: false,
})
export class DetallesPublicacionPersonalPage implements OnInit {
